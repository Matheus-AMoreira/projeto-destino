...
import ViagensCadastradas from "./pages/administracao/pacote/registrar/ViagensCadastradas";
import Validar from "./pages/administracao/usuario/listar/Validar";
...
import RegistrarPacoteFoto from "./pages/administracao/pacote/registrar/RegistrarPacoteFoto";
import PacotesFotoLista from "./pages/administracao/pacote/listar/PacotesFotoLista";
import Dashboard from "./pages/administracao/dashboard/Dashboard";
import AdminLayout from "./pages/administracao/AdminLayout";
import HotelLista from "./pages/administracao/pacote/listar/HotelLista";
import TransporteLista from "./pages/administracao/pacote/listar/TransporteLista";
import RegistrarHotel from "./pages/administracao/pacote/registrar/RegistrarHotel";
import RegistrarTransporte from "./pages/administracao/pacote/registrar/RegistrarTransporte";
